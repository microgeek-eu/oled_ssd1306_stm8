...
set CC_FLAGS=-mstm8 --std-c11 --opt-code-size --vc -DSTM8S105 -DUSE_STDPERIPH_DRIVER
...
sdcc %CC_FLAGS% --out-fmt-ihx stm8s105.lib interrupt.rel hw_setup.rel oled_ssd1306.rel gfx_bw.rel main.c
