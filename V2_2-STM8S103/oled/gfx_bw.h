/**
  *****************************************************************************
  * @file           : gfx_bw.h
  * @brief          : Header for graphics routines for black and white displays
  *
  *****************************************************************************
  * @attention
  *
...
/* Private macro -------------------------------------------------------------*/
/**
  * @brief  Map the pixel manipulating to the low level function
	*/
...
#if (USING_FILL_ROUND_RECTANGLE == 1) || (USING_STRETCH_FONTS == 1)
